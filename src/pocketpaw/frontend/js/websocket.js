...
class PocketPawSocket {
    ...
    saveSettings(settings) {
        this.send('settings', {
            ...
            budget_monthly_usd: parseFloat(settings.budgetMonthlyUsd) || 0,
            budget_warning_threshold: parseFloat(settings.budgetWarningThreshold) || 0.8,
            budget_auto_pause: settings.budgetAutoPause,
            budget_reset_day: parseInt(settings.budgetResetDay) || 1,
            trace_retention_days: parseInt(settings.traceRetentionDays) || 30,
